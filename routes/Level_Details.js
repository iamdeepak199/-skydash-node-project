...
router.get('/Level_Details', async (req, res) => {
    try {
        ...
        const [results] = await db.query(`SELECT * FROM income_log LIMIT ? OFFSET ?`, [limit, offset]);

        // Query to get the total count of records
        const [countResult] = await db.query('SELECT COUNT(*) AS count FROM income_log');
